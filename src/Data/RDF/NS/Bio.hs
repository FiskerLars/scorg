...
|-}
allEmployments:: RDFdb -> R.Subject -> [R.Subject]
...
intervalOf:: RDFdb -> R.Subject -> Maybe R.Subject
...
fromBioDate:: RDFdb -> R.Subject -> Maybe DateTime
...
maybeGetBioDate:: RDFdb -> R.Subject -> R.Predicate -> Maybe DateTime
...
fromIntervalSubject:: RDFdb -> R.Subject -> BioInterval
...
getBioInterval:: RDFdb -> R.Subject -> Maybe BioInterval
...
sortEmployments:: RDFdb -> [R.Subject] -> [R.Subject]
